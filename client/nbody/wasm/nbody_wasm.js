 ...
 * @returns {Universe}
 */
export function start_simulation(num_bodies) {
    const ret = wasm.start_simulation(num_bodies);
...
export class Universe {
     ...
     * @returns {Universe}
     */
    static new(num_bodies) {
        const ret = wasm.universe_new(num_bodies);
        return Universe.__wrap(ret);
    }
    init() {
        wasm.universe_init(this.__wbg_ptr);
    }
    /**
     * @param {number} n
     */
    step_n(n) {
        wasm.universe_step_n(this.__wbg_ptr, n);
    }
    /**
     * @returns {number}
     */
    get_positions() {
        const ret = wasm.universe_get_positions(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @returns {number}
     */
    get_masses() {
        const ret = wasm.universe_get_masses(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @returns {number}
     */
    get_velocities() {
        const ret = wasm.universe_get_velocities(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @returns {number}
     */
    get_num_bodies() {
        const ret = wasm.universe_get_num_bodies(this.__wbg_ptr);
        return ret >>> 0;
    }
}
...
async function __wbg_init(module_or_path, memory) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('nbody_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
