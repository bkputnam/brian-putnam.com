...
export const CELL_WIDTH_PX = parseInt(
  bodyStyle.getPropertyValue("--letter-side-len")
);
export const BORDER_WIDTH = parseInt(
  bodyStyle.getPropertyValue("--border-width")
);
